import pymongo
from urllib.request import Request,URLopener,HTTPCookieProcessor,build_opener
...
def create_user(username, password):
    try:
        ...
        data = urlencode([("email", ""), ("username", username), ("password", password), ("verify", password)]).encode('utf-8')
